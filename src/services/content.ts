...
import uaParse from '../middlewares/useragent';

const app = PromiseRouter();

app.get("/api/pages/fortnite-game", uaParse(false), async (req, res) => {
    const content = await getContent();

    const bDisabledCloudstorage = req.clientInfos.friendlyVersion.startsWith('9.4');

    const emergencyBody = (
        bDisabledCloudstorage ?
            `The version of fortnite (${req.clientInfos.friendlyVersion}) you are using have disabled cloudstorage. This means that party and matchmaking are disabled for this build\nNeonite v3 `
            : '')
        + `Made by BeatYT (@TheBeatYT_evil).\nDiscord: https://discord.gg/DJ6VUmD`;

    const emergencyTitle = bDisabledCloudstorage ? 'Warning about current Verison' : 'Neonite V3';
            ...
            messages: [
                {
                    ...
                    image: `https://cdn.neonite.net/NeoniteWallpaper.png`,
                    title: "Neonite V3",
            ...
            motds: [
                {
                    ...
                    image: `https://cdn.neonite.net/NeoniteWallpaper.png`,
                    tileImage: `https://cdn.neonite.net/NeoniteMidLogo.png`,
                    title: "Neonite V3",
    ...
    const emergencynotice = {
        ...
        lastModified: "2022-12-18T17:19:10.185Z",
        _locale: 'en-US'
    };
    ...
    res.json(
        {
            ...
            subgameinfo: {
                battleroyale: {
                    image: 'https://cdn.neonite.net/Neo_Text.jpg',
                    color: '5b2569',
                    _type: 'Subgame Info',
            ...
            subscription: {
                ...
                "nextRewards": {
                    ...
                    "battlepassTileImageURL": "https://cdn.neonite.net/NeoniteWallpaper.png",
                    "skinTitle": "",
                    "mtxTitle": "",
                    "crewPackItems": [
                        {
                    ...
                    "battlepassTitle": "",
                    "itemShopTileImageURL": "https://cdn.neonite.net/NeoniteWallpaper.png",
                    ...
                    "recurringBenefits": [
                        {
                            ...
                            "details": {
                                ...
                                "title": "Battle Pass",
                                "backgroundImageURL": "https://cdn.neonite.net/NeoniteWallpaper.png"
                            }
                        },
                        {
                            "tileType": "CrewPack",
            ...
            playersurvey: {
                "s": {
                    "s": [
                        ...
                        },
                        {
                            ...
                            "t": "We want your feedback! lol",
                            "id": "DoYouLikeItemShop2",
                            "po": {
                                "_type": "Player Survey - Message"
                            }
                        },
                            ...
                            "q": [
                                {
                                    "mc": {
                                        ...
                                        "t": "Do you feel the <keyword>Saucer</> vehicle is (1) Too Weak, (3) Just Right, or (5) Too Strong?",
                                        "_type": "Player Survey - Multiple Choice Question"
                                    },
                                    "_type": "Player Survey - Question Container"
                                },
                                {
                                    "mc": {
                                        ...
                                        "t": "Do you feel the Health of the <keyword>Saucer</> vehicle is (1) Too Low, (3) Just Right, or (5) Too High?",
                                        "_type": "Player Survey - Multiple Choice Question"
                                    },
                                    "_type": "Player Survey - Question Container"
                                },
                                {
                                    "mc": {
                                        ...
                                        "t": "In your games, is your chance of encountering a <keyword>Saucer</> vehicle (1) Too Low, (3) Just Right, or (5) Too High?",
                                        "_type": "Player Survey - Multiple Choice Question"
                                    },
                                    "_type": "Player Survey - Question Container"
                                },
                                {
                                    "mc": {
                                        ...
                                        "t": "Overall, how do you feel about the <keyword>Saucer</> vehicle in Fortnite Battle Royale?",
                                        "_type": "Player Survey - Multiple Choice Question"
                                    },
                                    "_type": "Player Survey - Question Container"
                                }
                ...
                "_locale": "en-US",
                "_templateName": "FortnteGamePlayerSurvey"
            },
            subgameselectdata: {
                saveTheWorldUnowned: {
            ...
            shopCarousel: {
                itemsList: {
                    ...
                    items: [{
                        tileImage: `https://cdn.neonite.net/NeoniteWallpaper.png`,
                        fullTitle: "Neonite",
                        hidden: false,
            ...
            _suggestedPrefetch: [
                `https://cdn.neonite.net/NeoniteWallpaper.png`,
                `https://cdn.neonite.net/NeoniteMidLogo.png`
            ]
        }
    );
});
