...
app.post('/api/v1/assets/Fortnite/:version/:netcl', verifyAuthorization(), userAgentParse(true),  (req, res) => {
    const wantedKeys = Object.keys(req.body);

    res.json(
        {
            "FortCreativeDiscoverySurface": buildFortCreativeDiscoverySurface(req.clientInfos.friendlyVersion),
...
function buildFortCreativeDiscoverySurface(version: string) {
    return {
        "meta": {
            "promotion": 1
        },
                    ...
                    "TestCohorts": [
                        {
                            ...
                            "PlatformWhitelist": [],
                            "SelectionChance": 1,
                            "TestName": `V2-${version}_2/10/2022_PC_Epics_Picks`
                        }
                    ],
